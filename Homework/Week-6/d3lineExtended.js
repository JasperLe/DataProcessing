...
///
    ...
    var x0 = x.invert(d3.mouse(this)[0]),
        ...
        d1 = data1[i],
        d = x0 - d0.Datum > d1.Datum - x0 ? d1 : d0;
    focus2.attr("transform", "translate(" + x(d.Datum) + "," + y(d.GemiddeldeTemperatuur) + ")");
    focus2.select("text").text("Gemiddeld: " + d.GemiddeldeTemperatuur + ", Maximum: " + d.MaximumTemperatuur + ", Minimum: " + d.MinimumTemperatuur);
    }
